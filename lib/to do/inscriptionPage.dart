...
class _InscriptionPageState extends State<InscriptionPage> {
  ...
  Future<http.Response> fetchRegister(String login, String mdp) {
    return http.post(
      Uri.parse('https://s3-4295.nuage-peda.fr/Qrent/public/api/users'),
  ...
  // methode qui permet la l'inscription si les champs du formulaires sont valides
  startLoading() async {
    setState(() {
      _isLoading = true;
    });
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Erreur dans le l'enregistrement"),
        ),
      );
      setState(() {
        _isLoading = false;
            ...
            children: <Widget>[
              ...
              TextFormField(
                decoration: const InputDecoration(
                    ...
                    labelText: "E-mail",
                    hintText: "Saisir une adresse e-mail"),
                validator: (value) {
